...
export const cnASandInterdomainRouting: BlogPost = {
    slug: "computer-networks/AS-and-interdomain-routing-algorithm",
    categorySlug: "computer-networks",
    title: {
        ko: "AS와 인터도메인 라우팅 알고리즘",
        en: "AS and Interdomain Algorithm",
    },
    date: "2025-02-24 21:18",
    category: {
        ko: "컴퓨터 네트워크",
        en: "Computer Networks",
    },
    description: {
        ko: "AS와 인터도메인 라우팅에 대해 알아봅시다",
        en: "Autonomous System and Interdomain Algorithm",
    },
    content: `
## 인터넷 생태계의 구성 요소
