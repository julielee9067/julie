...
export const cnInternetArchitectureIntro: BlogPost = {
    slug: "computer-networks/intro-to-internet-architecture",
    categorySlug: "computer-networks",
    title: {
        ko: "인터넷 아키텍쳐 개요",
        en: "Introduction to Internet Architecture",
    },
    date: "2025-02-22",
    category: {
        ko: "컴퓨터 네트워크",
    ...
    description: {
        ko: "인터넷 아키텍쳐와 OSI 7계층에 대한 간단한 설명",
        en: "Intro to internet architecture and OSI 7 layers",
    },
    content: `
## 개요
