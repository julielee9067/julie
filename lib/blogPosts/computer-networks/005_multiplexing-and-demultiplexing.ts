...
export const cnMultiplexingAndDemultiplexing: BlogPost = {
    slug: "computer-networks/multiplexing-demultiplexing",
    categorySlug: "computer-networks",
    title: {
        ko: "전송 계층의 멀티플렉싱과 디멀티플렉싱",
        en: "Transport layer's Multiplexing and Demultiplexing",
    },
    date: "2025-02-23",
    category: {
        ko: "컴퓨터 네트워크",
    ...
    description: {
        ko: "전송 계층의 멀티플렉싱/디멀티플렉싱에 대해 알아봅시다",
        en: "How multiplexing/demultiplexing work in transport layer",
    },
    content: `
## 멀티플렉싱/디멀티플렉싱
