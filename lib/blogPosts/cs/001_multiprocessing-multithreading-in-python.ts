...
export const csMultiprocessingAndMultiThreadingInPython: BlogPost = {
    slug: "cs/multiprocessing-and-multithreading-in-python",
    categorySlug: "cs",
    title: {
        ko: "파이썬에서의 멀티프로세싱과 멀티쓰레딩",
        en: "Multiprocessing and Multithreading in Python",
    },
    date: "2025-02-21",
    category: {
        ko: "컴퓨터 공학",
    ...
    description: {
        ko: "멀티 프로세싱과 멀티 쓰레딩의 파이썬에서의 동작 원리",
