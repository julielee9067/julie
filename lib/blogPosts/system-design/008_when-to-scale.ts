...
export const systemDesignWhenToScale: BlogPost = {
    slug: "system-design/when-to-scale",
    categorySlug: "system-design",
    title: {
        ko: "언제 샤딩이 필요한가",
        en: "When should we shard our system",
    },
    date: "2025-03-15 15:17",
    category: {
        ko: "시스템 디자인",
        en: "System Design",
    },
    description: {
        ko: "현대 하드웨어 기준 샤딩이 정말 필요할 때",
        en: "When should we shard our system based on modern hardware",
    },
    content: `
## 개요
