...
export const systemDesignHierarchicalClustering: BlogPost = {
    slug: "system-design/hierarchical-clustering",
    ...
    description: {
        ko: "계층적 클러스터링 적용 과정과 다른 클러스터링 기법과의 비교",
        en: "Hierarchical clustering and comparison with other clustering methods",
    },
    content: `
## 개요
