...
export const systemDesignPostSearch: BlogPost = {
    slug: "system-design/post-search",
    categorySlug: "system-design",
    title: {
        ko: "게시글 검색 서비스 시스템 디자인",
        en: "Design post search service",
    },
    ...
    description: {
        ko: "대규모 검색 서비스 설계",
        en: "System design for post searching service",
    },
    content: `
## 개요
