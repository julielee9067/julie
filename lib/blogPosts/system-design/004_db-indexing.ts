...
export const systemDesignDBIndexing: BlogPost = {
    slug: "system-design/database-indexing",
    categorySlug: "system-design",
    title: {
        ko: "데이터베이스 인덱싱",
        en: "Database Indexing",
    },
    date: "2025-02-27 00:43",
    category: {
        ko: "시스템 디자인",
        en: "System Design",
    },
    description: {
        ko: "데이터베이스 인덱싱 기본 개념 및 동작 원리",
        en: "Intro to DB index and how it works",
    },
    content: `
## 개요
