...
중간에 복습 차원에서 두세 번 다시 푼 문제도 있지만, 대부분 처음 접하는 문제들이었다.

나는 뭔가 한 번 시작하면 끝을 봐야 직성이 풀리는 성격이라 잠도 줄이면서 문제를 풀었고, 중간고사까지 겹쳐서(2월 말에 문제 조금만 푼 날들은 중간고사 대비한 날들) 스트레스가 꽤 심했다.
...
이렇게 준비해도 면접에선 긴장해서 머리가 하얘질 때가 있다.
